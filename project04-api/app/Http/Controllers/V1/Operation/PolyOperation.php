...
use App\Http\Controllers\V1\Operation\MonoOperation;
...
class PolyOperation implements MathOperationInterface
{
    ...
    {
        if(
            $type1::class != 'App\Http\Controllers\V1\Types\Poly' ||
            ($type2 && $type2::class != 'App\Http\Controllers\V1\Types\Poly')
        ){
            throw new Exception('argument must be type of App\Http\Controllers\V1\Types\Poly');
        }
    }
}